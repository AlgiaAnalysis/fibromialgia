                    ...
                    <div class="flex flex-row items-center justify-between py-4 md:py-8">
                        ...
                        <div class="flex items-center">
                            ...
                            <button
                                ...
                                <span class="text-white font-medium">Paciente</span>
                            </button>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex flex-col h-full overflow-y-auto pb-20">
                    ...
                    <nav class="py-4 flex-1" aria-label="Navegação mobile">
                        <a href="{{ route('patient.dashboard') }}"
                           @click="sidebarOpen = false"
                           :class="activeTab === 'patient.dashboard' ? 'bg-blue-50 border-l-4 border-blue-500' : ''"
                        ...
                        <a href="{{ route('patient-doctor-list') }}"
                           @click="sidebarOpen = false"
                           :class="activeTab === 'patient-doctor-list' ? 'bg-blue-50 border-l-4 border-blue-500' : ''"
                           class="flex items-center px-6 py-3 text-gray-700 hover:bg-gray-50 hover:text-gray-900 transition-colors duration-200">
                            <i class="fad fa-user-md text-gray-500 mr-3"></i>
